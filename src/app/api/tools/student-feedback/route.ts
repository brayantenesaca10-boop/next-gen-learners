...
- Keep it to 150-250 words — long enough to be useful, short enough to be read`;
  ...
  try {
    ...
    await logActivity({ person: data._actor || 'unknown', action: 'wrote student feedback', resource_type: 'tool', resource_name: student_name || 'student', details: assignment_description });
